...
<!-- saved from url=(0146)https://cc.bingj.com/cache.aspx?q=site%3asquirtmusic.com+coming+soon&d=4606747769974994&mkt=en-US&setlang=en-US&w=FN6CfmFoCtsu6B3PSIac493on4j-TUu5 -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css">.disclaimer{text-align:right;font-size:x-small}.banner{background-color:#fff;text-align:left}.cacheContent{position:relative}.b_vPanel>div{padding-bottom:10px}.b_vPanel>div:last-child{padding:0}.banner a{color:#4007a2}</style><!--<base href="https://squirtmusic.com/contact.php">--><base href="."><!-- Banner:Start --><!--LocalizedDate:7/22/2022--><!--InvariantDate:7/22/2022--></head><body><div class="banner"><div class="b_vPanel"><div><!-- Title:Start -->You have reached the cached page for <strong><a href="https://squirtmusic.com/contact.php" h="ID=SERP,5003.1">https://squirtmusic.com/contact.php</a></strong><!-- Title:End --></div><div><!-- Content:Start -->Below is a snapshot of the Web page as it appeared on <strong>7/22/2022</strong> (the last time our crawler visited it). This is the version of the page that was used for ranking your search results. The page may have changed since we last cached it. To see what might have changed (without the highlights), <a href="https://squirtmusic.com/contact.php" h="ID=SERP,5003.2">go to the current page</a>.<!-- Content:End --></div><div><!-- Hit:Start -->You searched for: <!--HitHighlight:Start-->site:squirtmusic.com <b style="color:#000;background:#ffff66">coming</b> <b style="color:#000;background:#66ffff">soon</b><!--HitHighlight:End--> We have highlighted matching words that appear in the page below.<!-- Hit:End --></div><div><!-- Disclaimer:Start --><div class="disclaimer">Bing is not responsible for the content of this page.</div><!-- Disclaimer:End --></div><!-- Banner:End --></div></div><div class="cacheContent">
		...
		<meta property="og:url" content="https://squirtmusic.com">		<meta name="Description" content="Go back in the past and contact the members of Squirt as they were circa the year 2000.">					
	
		
		<a href="https://squirtmusic.com/"><img src="./contact_files/logo.jpg" width=""></a>
...
<div id="primary-navigation" class="text-right">
	...
	<a class="active" href="https://squirtmusic.com/contact.php">Contact</a> 
</div>				
		<div class="center">
			<h1>Contact</h1>
